...
if($animated) {
	...
	$out = "<div class='menu menu--anim-bttn'>{$open_menu_button}<ul class='menu__entries' data-action='closeMenuTool'>";
} else {
	...
	$out = "<div class='menu menu--static-bttn'>{$open_menu_button}<ul class='menu__entries' data-action='closeMenuTool'>{$close_menu_button}";
