...
$open_menu_button = '';
$close_menu_button = '';
$menu_overlay = "<div class='menu__entry-overlay' data-action='closeMenuTool'></div>";
...
if($animated) {
	...
	$out = "<div class='menu menu--anim-bttn'>{$open_menu_button}{$menu_overlay}<ul class='menu__entries' data-action='closeMenuTool'>";
} else {
	...
	$out = "<div class='menu menu--static-bttn'>{$open_menu_button}{$menu_overlay}<ul class='menu__entries' data-action='closeMenuTool'>{$close_menu_button}";
